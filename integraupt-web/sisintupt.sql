...
-- Volcando datos para la tabla sisintupt.auditoriareserva: ~9 rows (aproximadamente)
INSERT INTO `auditoriareserva` (`IdAudit`, `IdReserva`, `EstadoAnterior`, `EstadoNuevo`, `FechaCambio`, `UsuarioCambio`) VALUES
	...
	(22, 52, 'Pendiente', 'Rechazada', '2025-11-26 19:34:39', 15),
	(23, 53, 'Pendiente', 'Aprobada', '2025-11-26 19:35:36', 15),
	(24, 51, 'Pendiente', 'Aprobada', '2025-11-27 11:59:43', 15);
...
-- Volcando datos para la tabla sisintupt.horarios: ~306 rows (aproximadamente)
INSERT INTO `horarios` (`IdHorario`, `espacio`, `bloque`, `diaSemana`, `ocupado`) VALUES
	...
	(770, 9, 10, 'Lunes', 0),
	(771, 9, 10, 'Martes', 0),
	(772, 9, 10, 'Miercoles', 0),
	(773, 9, 10, 'Jueves', 0),
	(774, 9, 10, 'Viernes', 0),
	(775, 9, 10, 'Sabado', 0),
	(776, 9, 11, 'Lunes', 0),
	(777, 9, 11, 'Martes', 0),
	(778, 9, 11, 'Miercoles', 0),
	(779, 9, 11, 'Jueves', 0),
	(780, 9, 11, 'Viernes', 0),
	(781, 9, 11, 'Sabado', 0),
	(782, 9, 12, 'Lunes', 0),
	(783, 9, 12, 'Martes', 0),
	(784, 9, 12, 'Miercoles', 0),
	(785, 9, 12, 'Jueves', 0),
	(786, 9, 12, 'Viernes', 0),
	(787, 9, 12, 'Sabado', 0),
	(788, 9, 13, 'Lunes', 0),
	(789, 9, 13, 'Martes', 0),
	(790, 9, 13, 'Miercoles', 0),
	(791, 9, 13, 'Jueves', 0),
	(792, 9, 13, 'Viernes', 0),
	(793, 9, 13, 'Sabado', 0),
	(794, 9, 14, 'Lunes', 0),
	(795, 9, 14, 'Martes', 0),
	(796, 9, 14, 'Miercoles', 0),
	(797, 9, 14, 'Jueves', 0),
	(798, 9, 14, 'Viernes', 0),
	(799, 9, 14, 'Sabado', 0),
	(800, 9, 15, 'Lunes', 0),
	(801, 9, 15, 'Martes', 0),
	(802, 9, 15, 'Miercoles', 0),
	(803, 9, 15, 'Jueves', 0),
	(804, 9, 15, 'Viernes', 0),
	(805, 9, 15, 'Sabado', 0),
	(806, 9, 16, 'Lunes', 0),
	(807, 9, 16, 'Martes', 0),
	(808, 9, 16, 'Miercoles', 1),
	(809, 9, 16, 'Jueves', 0),
	(810, 9, 16, 'Viernes', 0),
	(811, 9, 16, 'Sabado', 0),
	(812, 9, 17, 'Lunes', 0),
	(813, 9, 17, 'Martes', 0),
	(814, 9, 17, 'Miercoles', 0),
	(815, 9, 17, 'Jueves', 0),
	(816, 9, 17, 'Viernes', 0),
	(817, 9, 17, 'Sabado', 0);
...
INSERT INTO `horario_curso` (`IdHorarioCurso`, `Curso`, `Docente`, `Espacio`, `Bloque`, `DiaSemana`, `FechaInicio`, `FechaFin`, `Estado`) VALUES
	...
	(5, 1, 20, 9, 1, 'Miercoles', '2025-11-27', '2025-12-30', 1);
...
-- Volcando datos para la tabla sisintupt.reserva: ~21 rows (aproximadamente)
INSERT INTO `reserva` (`IdReserva`, `usuario`, `espacio`, `bloque`, `curso`, `fechaReserva`, `fechaSolicitud`, `DescripcionUso`, `CantidadEstudiantes`, `Estado`) VALUES
	...
	(51, 18, 1, 16, 1, '2025-11-27', '2025-11-27 00:21:14', 'Vamos Probar', 10, 'Aprobada'),
	(52, 16, 9, 17, 1, '2025-11-26', '2025-11-27 00:34:12', 'hOLA', 5, 'Rechazada'),
	(53, 16, 9, 16, 1, '2025-11-26', '2025-11-27 00:35:18', 'Stevie', 4, 'Aprobada');
...
-- Volcando datos para la tabla sisintupt.reserva_gestion: ~10 rows (aproximadamente)
INSERT INTO `reserva_gestion` (`IdGestion`, `IdReserva`, `UsuarioGestion`, `FechaGestion`, `Accion`, `Motivo`, `Comentarios`) VALUES
	...
	(15, 52, 15, '2025-11-27 00:34:39', 'Rechazar', 'jALO', 'Mas informacion'),
	(16, 53, 15, '2025-11-27 00:35:36', 'Aprobar', 'Feliz navidad', 'ad'),
	(17, 51, 15, '2025-11-27 16:59:43', 'Aprobar', 'asdasd', 'adsasdasd');
...
-- Volcando datos para la tabla sisintupt.sancion: ~2 rows (aproximadamente)
INSERT INTO `sancion` (`IdSancion`, `Usuario`, `Motivo`, `FechaInicio`, `FechaFin`, `Estado`, `TipoUsuario`) VALUES
	(1, 18, 'asdasd', '2025-11-26', '2025-11-26', 'CUMPLIDA', 'ESTUDIANTE'),
	(2, 18, 'Stevie', '2025-11-26', '2025-11-26', 'CUMPLIDA', 'ESTUDIANTE');
...
-- Volcando datos para la tabla sisintupt.usuario: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla sisintupt.usuario_auth: ~8 rows (aproximadamente)
