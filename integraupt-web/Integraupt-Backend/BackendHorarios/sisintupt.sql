...
-- Volcando datos para la tabla sisintupt.cursos: ~1 rows (aproximadamente)
...
INSERT INTO `espacio` (`IdEspacio`, `Codigo`, `Nombre`, `Tipo`, `Capacidad`, `Equipamiento`, `Escuela`, `Estado`) VALUES
	(1, 'Q-312', 'LAB B', 'Laboratorio', 35, 'PC', 2, 1),
	(2, 'Q-311', 'Q-311', 'Salon', 40, 'AS', 2, 1);
...
-- Volcando datos para la tabla sisintupt.estudiante: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla sisintupt.horarios: ~12 rows (aproximadamente)
...
INSERT INTO `reserva` (`IdReserva`, `usuario`, `espacio`, `bloque`, `curso`, `fechaReserva`, `fechaSolicitud`, `DescripcionUso`, `CantidadEstudiantes`, `Estado`) VALUES
	(38, 5, 1, 1, 1, '2025-11-08', '2025-11-08 23:59:18', 'sadas', 1, 'Pendiente');
...
INSERT INTO `usuario` (`IdUsuario`, `Nombre`, `Apellido`, `TipoDoc`, `NumDoc`, `Rol`, `Celular`, `Genero`, `Estado`, `FechaRegistro`) VALUES
	(5, 'STEVIE', 'MARCA', 1, '72405382', 2, '979793902', b'1', 1, '2025-11-01 00:00:00'),
