...
INSERT INTO `silabo` (`IdSilabo`,`CodigoCurso`,`NombreCurso`,`CicloNumero`,`Semestre`,`Horas`,`Creditos`,`Docente`,`CorreoDocente`,`HorarioCursoId`,`DiasXSemana`,`ArchivoPdf`,`FechaCarga`,`Estado`,`created_at`,`updated_at`) VALUES
-- Docente 1: JUAN ALBERTO RODRIGUEZ PAZ (juarodr@upt.pe)
(2,'IS-701','Ingeniería de Software I',7,'2026-I',4,4,'JUAN ALBERTO RODRIGUEZ PAZ','juarodr@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:00:00','2026-06-30 08:00:00'),
(3,'BD-601','Base de Datos I',6,'2026-I',4,4,'JUAN ALBERTO RODRIGUEZ PAZ','juarodr@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:05:00','2026-06-30 08:05:00'),
(4,'AD-601','Análisis y Diseño de Sistemas',6,'2026-I',3,3,'JUAN ALBERTO RODRIGUEZ PAZ','juarodr@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:10:00','2026-06-30 08:10:00'),
-- Docente 2: ISRAEL NAZARETH CHAPARRO CRUZ (isrchap@upt.pe)
(5,'ED-501','Estructuras de Datos',5,'2026-I',4,4,'ISRAEL NAZARETH CHAPARRO CRUZ','isrchap@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:15:00','2026-06-30 08:15:00'),
(6,'AL-401','Algoritmos y Programación',4,'2026-I',3,3,'ISRAEL NAZARETH CHAPARRO CRUZ','isrchap@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:20:00','2026-06-30 08:20:00'),
(7,'IA-901','Inteligencia Artificial',9,'2026-I',3,3,'ISRAEL NAZARETH CHAPARRO CRUZ','isrchap@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:25:00','2026-06-30 08:25:00'),
(8,'SO-601','Sistemas Operativos',6,'2026-I',4,4,'ISRAEL NAZARETH CHAPARRO CRUZ','isrchap@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:30:00','2026-06-30 08:30:00'),
-- Docente 3: LUIS ENRIQUE MARTINEZ CRUZ (luimart@upt.pe)
(9,'RC-801','Redes de Computadoras',8,'2026-I',4,4,'LUIS ENRIQUE MARTINEZ CRUZ','luimart@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:35:00','2026-06-30 08:35:00'),
(10,'DW-501','Diseño Web y Aplicaciones',5,'2026-I',3,3,'LUIS ENRIQUE MARTINEZ CRUZ','luimart@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:40:00','2026-06-30 08:40:00'),
(11,'BD-602','Base de Datos II',7,'2026-I',4,4,'LUIS ENRIQUE MARTINEZ CRUZ','luimart@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:45:00','2026-06-30 08:45:00'),
-- Docente 4: CARLOS PATRICIO PEREZ LOZANO (carpere@upt.pe)
(12,'CI-211','Mecánica de Materiales',2,'2026-I',4,4,'CARLOS PATRICIO PEREZ LOZANO','carpere@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:50:00','2026-06-30 08:50:00'),
(13,'CI-411','Resistencia de Materiales',4,'2026-I',4,4,'CARLOS PATRICIO PEREZ LOZANO','carpere@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 08:55:00','2026-06-30 08:55:00'),
(14,'CI-611','Concreto Armado',6,'2026-I',4,4,'CARLOS PATRICIO PEREZ LOZANO','carpere@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 09:00:00','2026-06-30 09:00:00'),
(15,'CI-711','Hidráulica General',7,'2026-I',3,3,'CARLOS PATRICIO PEREZ LOZANO','carpere@upt.pe',NULL,2,NULL,NULL,1,'2026-06-30 09:05:00','2026-06-30 09:05:00');
